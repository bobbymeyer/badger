...
| 8–9 | Primitives and illustration containers, engine | not started |
...
- Step 8: the shape primitives (circle, ellipse, rectangle, lozenge, rounded rect, shield) and illustration containers that measure ink bounds and take one slot.
