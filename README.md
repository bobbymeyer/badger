...
| 6–9 | Union scope, knockout, offset stroke, color slots, primitives, engine | not started |
...
- Step 6: union scope (per line or whole block), knockout, and the single offset stroke, on skia-pathops through the sidecar.
