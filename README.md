...
| 5–9 | Container tree, union/knockout, color slots, primitives, engine | not started |
...
- Step 5: the container tree, child coordinates relative to the parent, and locator plus alignment anchoring.
